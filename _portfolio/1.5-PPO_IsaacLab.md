...
excerpt: "Implementation of the Proximal Policy Optimization (PPO) algorithm, tested with multiple environments within IsaacLab<br><img src='/images/ppo_cabinet.gif' width='50%'>"
...
<p float="left">
    <img src='/images/training_plot_episodes_Isaac-Reach-Franka-v0.png' width='40%'>  
</p>
<p float="left">
    <img src='/images/training_plot_episodes_Isaac-Open-Drawer-Franka-v0.png' width='40%'> <img src='/images/ppo_cabinet.gif' width="40%">  
</p>
