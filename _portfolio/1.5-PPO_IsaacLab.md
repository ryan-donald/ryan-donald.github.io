...
excerpt: "Implementation of the Proximal Policy Optimization (PPO) algorithm, tested with multiple environments within IsaacLab<br><img src='/images/isaac_cabinet.gif' width='50%'>"
...
<p float="left">
    <img src='/images/training_plot_episodes_Isaac-Cartpole-v0.svg' onerror this.src='/images/training_plot_episodes_Isaac-Cartpole-v0.png' width='40%'> <img src='/images/isaac_cartpole.gif' width="40%">  
</p>
<p float="left">
    <img src='/images/training_plot_episodes_Isaac-Reach-Franka-v0.svg' onerror this.src='/images/training_plot_episodes_Isaac-Reach-Franka-v0.png' width='40%'> <img src='/images/isaac_reach.gif' width="40%"> 
</p>
<p float="left">
    <img src='/images/training_plot_episodes_Isaac-Lift-Cube-Franka-v0.svg' onerror this.src='/images/training_plot_episodes_Isaac-Lift-Cube-Franka-v0.png' width='40%'> <img src='/images/isaac_lift.gif' width="40%">  
</p>
<p float="left">
    <img src='/images/training_plot_episodes_Isaac-Open-Drawer-Franka-v0.svg' onerror this.src='/images/training_plot_episodes_Isaac-Open-Drawer-Franka-v0.png' width='40%'> <img src='/images/isaac_cabinet.gif' width="40%">  
</p>
