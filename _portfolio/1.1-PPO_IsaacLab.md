...
<p float="left">
    <img src='/images/training_plot_episodes_Isaac-Cartpole-v0.png' width='49%'> <video src='/images/isaac_cartpole.mp4' width="49%" style="vertical-align: middle" autoplay loop muted playsinline></video>  
</p>
<p float="left">
    <img src='/images/training_plot_episodes_Isaac-Reach-SO-ARM101-v0.png' width='49%'> <video src='/images/isaac_reach_so101.mp4' width="49%" style="vertical-align: middle" autoplay loop muted playsinline></video>  
</p>
<p float="left">
    <img src='/images/training_plot_episodes_Isaac-Lift-Cube-Franka-v0.png' width='49%'> <video src='/images/isaac_lift.mp4' width="49%" style="vertical-align: middle" autoplay loop muted playsinline></video>  
</p>
<p float="left">
    <img src='/images/training_plot_episodes_Isaac-Open-Drawer-Franka-v0.png' width='49%'> <video src='/images/isaac_drawer.mp4' width="49%" style="vertical-align: middle" autoplay loop muted playsinline></video>  
</p>
 <p float="left">
    <img src='/images/training_plot_episodes_Isaac-Repose-Cube-Allegro-v0.png' width='49%'> <video src='/images/isaac_repose_allegro.mp4' width="49%" style="vertical-align: middle" autoplay loop muted playsinline></video>  
</p>