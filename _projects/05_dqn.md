...
description: A DQN implementation trained on the Cart Pole Gymnasium environment
img: assets/img/thumb_dqn.jpg
importance: 5
...
![png]({{ site.baseurl }}/assets/img/Deep-Q-Network_25_0.png)
